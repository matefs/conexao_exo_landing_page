    ...
    <main>
      <section className="hero" id="inicio">
        ...
        <div className="hero__content wrap">
          <Eyebrow dark>Turismo de natureza em Florianópolis</Eyebrow>
      ...
      <section className="manifesto section" id="sobre"><div className="wrap manifesto__grid"><div><Eyebrow>Conexão EXO</Eyebrow><h2>Você já perdeu tempo demais vivendo sempre o mesmo dia.</h2></div><div className="prose"><p>Você acorda, resolve problemas, cumpre horários e chega ao fim do dia sem ter vivido nada que gostaria de guardar. Quando percebe, a semana acabou. Depois o mês. Depois mais um ano.</p><p>Se continuar esperando a agenda esvaziar ou a coragem aparecer sozinha, sua vida continuará empurrada para uma data que não existe.</p><strong>A Conexão EXO interrompe esse ciclo com experiências na água, a bordo, no ar e na terra.</strong><br/><ArrowLink href={whatsappUrl}>Quero quebrar esse ciclo</ArrowLink></div></div></section>
      ...
      <section className="reasons section"><div className="wrap"><SectionHeading eyebrow="Do seu jeito" title="Há muitas formas de viver uma nova conexão."/><div className="difference-list">{audiences.slice(0,4).map(([title,text], index) => <article className="difference-card" key={title} style={{backgroundImage:`url('${['/assets/floripa/ilha-do-frances.jpg','/assets/floripa/jurere.jpg','/assets/floripa/lagoinha-do-leste.jpg','/assets/floripa/santo-antonio-de-lisboa.jpg'][index]}')`}}><div className="difference-card__shade"/><div className="difference-card__content"><span>0{index+1}</span><h3>{title}</h3><p>{text}</p></div></article>)}</div></div></section>
      ...
      <section className="nationwide section"><div className="wrap split"><div><Eyebrow>No coração de Jurerê</Eyebrow><h2>Sua conexão começa em Florianópolis.</h2><p>A Conexão EXO está perto do mar e de muitas paisagens que tornam o norte da ilha especial para viver ao ar livre.</p><address><MapPin size={20}/><span>Alameda César Nascimento, 646, Sala 6<br/>Jurerê — Florianópolis — SC<br/>CEP 88053-500</span></address><Button href={whatsappUrl}>Chamar no WhatsApp</Button></div><div className="nationwide__visual"><img src="/assets/brasil.webp" alt="Localização da Conexão EXO em Florianópolis"/><span><MapPin size={18}/> Jurerê, Florianópolis</span></div></div></section>
